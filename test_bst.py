...
class BSTTestCase(unittest.TestCase):
    ...
    def test_inorder(self):
        ...
        self.assertListEqual(self.bst.inorder_walk(), [1, 5, 8, 10, 25, 30, 
                                                       40, 45, 52])
    ...
    def test_postorder(self):
        ...
        self.assertListEqual(self.bst.postorder_walk(), [1, 8, 5, 25, 30, 45, 
                                                        40, 52, 10])
    ...
    def test_preorder(self):
        ...
        """
        self.assertListEqual(self.bst.preorder_walk(), [10, 5, 1, 8, 52, 
                                                        40, 30, 45])
    ...
    def test_search(self):
        ...
        self.bst.remove(52)
        self.assertFalse(self.bst.search(52))
    ...
    def test_remove(self):
        ...
        self.assertListEqual(self.bst.preorder_walk(), [10, 5, 1, 52, 45, 30])
        self.assertListEqual(self.bst.inorder_walk(), [1, 5, 10, 30, 45, 52])
        self.assertListEqual(self.bst.postorder_walk(), [1, 5, 30, 45, 52, 10])
    ...
    def test_largest(self):
        ...
        self.bst.add(0, "Value for 0")
        self.bst.add(32, "Value for 32")
        self.bst.add(100, "Value for 100")

        # Now the largest key is 54
        self.assertTupleEqual(self.bst.largest(), (100, "Value for 100"))
